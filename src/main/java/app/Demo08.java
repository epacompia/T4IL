...
public class Demo08 {
	...
	public static void main(String[] args) {
		...
		String jpql="select u from Usuario u where u.idtipo= :xtipo"; //xtipo es una variable que va recibir el tipo de dato que yo le quiero dar
		List<Usuario> lstUsuarios= em.createQuery(jpql,Usuario.class).setParameter("xtipo",xtipo).getResultList();//getResultlist le devuelve la lsita d eusuarios, el primer valor del set parameter es el valor de :xtipo y el segundo valor es el int xtipo
